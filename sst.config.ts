  ...
  async run() {
    new sst.aws.Nextjs('MainWebsite', {
      ...
      environment: {
        ...
        CLOUDFLARE_ACCESS_KEY_ID: new sst.Secret('CLOUDFLARE_ACCESS_KEY_ID').value,
        ...
        EVALY_AWS_ACCESS_KEY_ID: new sst.Secret('EVALY_AWS_ACCESS_KEY_ID').value,
        EVALY_AWS_SECRET_ACCESS_KEY: new sst.Secret('EVALY_AWS_SECRET_ACCESS_KEY')
          .value,
        OPENAI_API_KEY: new sst.Secret('OPENAI_API_KEY').value,
        GOOGLE_GENERATIVE_AI_API_KEY: new sst.Secret('GOOGLE_GENERATIVE_AI_API_KEY')
          .value,
        NEXT_PUBLIC_URL: new sst.Secret('NEXT_PUBLIC_URL').value,
        NEXT_PUBLIC_POSTHOG_KEY: new sst.Secret('NEXT_PUBLIC_POSTHOG_KEY').value,
        NEXT_PUBLIC_POSTHOG_HOST: new sst.Secret('NEXT_PUBLIC_POSTHOG_HOST').value,
        NEXT_PUBLIC_SUPABASE_URL: new sst.Secret('NEXT_PUBLIC_SUPABASE_URL').value,
        NEXT_PUBLIC_SUPABASE_ANON_KEY: new sst.Secret('NEXT_PUBLIC_SUPABASE_ANON_KEY')
          .value
      }
    })
  }
